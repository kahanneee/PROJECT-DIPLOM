...
class TestUslugiPage:
    ...
    def test_contact_button(self, driver):  
        page = UslugiPage(driver)
        driver.get("https://ormea.pl/uslugi/")
    ...
    def test_page_elements_visibility(self, driver):  
        page = UslugiPage(driver)
        driver.get("https://ormea.pl/uslugi/")
